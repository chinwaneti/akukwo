...
function SignUp() {
  ...
  const handleSignUp = (e) => {
    ...
    .then((userCredential) => {
        ...
        setSucessMessage("Kindly Sign In.")
        setUser(user);
  ...
  return (
    <div className="bg-[#286f6b] overflow-hidden mt-10 min-h-screen flex items-center justify-center relative">
        <div className='absolute top-28 bg-yellow-500  rounded-t-3xl w-full max-w-sm text-center  '>
            {sucessMessage && (
      ...
      <Link to="/SignIn">
        <div className="absolute top-32 right-2 bg-white hover:bg-[#082c64]  active:bg-blue-950 p-2 rounded-full">
          <AiOutlineClose />
        </div>
      </Link>
